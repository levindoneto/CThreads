...
semaphore_test_2: all $(BIN_DIR)semaphore_test_2.o
	$(CC) $(CFLAGS) $(BIN_DIR)semaphore_test_2.o $(BIN_DIR)red_black_tree.o \
	$(BIN_DIR)cdata.o $(BIN_DIR)cthread.o $(BIN_DIR)able_threads.o \
	$(BIN_DIR)support.o -o test_3

$(BIN_DIR)semaphore_test_2.o: $(TST_DIR)semaphore_test_2.c
	$(CC) $(CFLAGS) -c -o $(BIN_DIR)semaphore_test_2.o -I$(INC_DIR) $(TST_DIR)semaphore_test_2.c
